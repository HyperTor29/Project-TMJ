...
use App\Filament\Resources\DataSecurityResource\Pages;
use App\Filament\Resources\DataSecurityResource\RelationManagers;
...
class DataSecurityResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateDataSecurity::route('/create'),
            'edit' => Pages\EditDataSecurity::route('/{record}/edit'),
        ];
    }
}

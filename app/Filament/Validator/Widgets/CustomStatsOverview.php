...
class CustomStatsOverview extends BaseWidget
{
    protected function getCards(): array
    {
        ...
        return [
            Card::make('Total Data Divalidasi', $totalForms)
                ->description('Jumlah total data yang telah divalidasi')
                ->descriptionIcon('heroicon-o-check-circle')
                ->color('primary'),

            Card::make('Data Baru Divalidasi (7 Hari Terakhir)', $recentForms)
                ->description('Jumlah data baru yang divalidasi dalam 7 hari terakhir')
